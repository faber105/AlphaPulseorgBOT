...
Timeframe = Literal["15s", "1m", "3m", "5m", "15m", "1h"]
...
class SignalAnalyzeRequest(BaseModel):
    ...
    category: Literal["forex", "crypto", "stocks", "commodities", "indices"]
    timeframe: Timeframe
...
class SessionStartRequest(BaseModel):
    ...
    trade_amount: Decimal = Field(gt=0)
    timeframe_filter: Timeframe | None = None
...
class AdminPaymentConfirmRequest(BaseModel):
    payment_id: int


class AdminSignalResultRequest(BaseModel):
